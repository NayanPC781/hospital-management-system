...
const PatientDashboard = () => {
  ...
  return (
    <div className="page-container">
      ...
      {(activeTab === 'overview' || searchParams.get('tab') === 'book') && (
        <>
      ...
      <PageHeader
        ...
        actions={(
          <div className="ui-inline-tabs">
            <button type="button" className={`btn btn-outline ${activeTab === 'overview' ? 'active' : ''}`} onClick={() => setSearchParams({ tab: 'overview' })}>Upcoming</button>
